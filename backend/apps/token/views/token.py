...
from apps.token.depends.get_token_decoded import get_token_decoded
...
def verify_token(token: str = Depends(get_token_decoded), jwt_token: str = Depends(get_jwt)) -> Any:
