...
class AccessTokenTestCase(TransactionTestCase):
    ...
    def test_get_app_good_scopes(self):
        headers = {"Authorization": f"bearer {self.access_token_good.access_token}"}
    ...
    def test_get_app_good_scopes_superset(self):
        headers = {"Authorization": f"bearer {self.access_token_superset.access_token}"}
    ...
    def test_get_app_good_scopes_none(self):
        headers = {"Authorization": f"bearer {self.access_token_none.access_token}"}
    ...
    def test_get_app_bad_scopes(self):
        headers = {"Authorization": f"bearer {self.access_token_bad.access_token}"}
